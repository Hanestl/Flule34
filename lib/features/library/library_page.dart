...
class _LibraryTabs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pages = <Widget>[
      ...
      if (loggedIn)
        VideoFeed(loadPage: api.loadFavorites, emptyMessage: '收藏夹里还没有视频。'),
      if (loggedIn)
        VideoFeed(loadPage: api.loadHistory, emptyMessage: '网站观看历史还是空的。'),
        ...
        children: [
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('媒体库', style: Theme.of(context).textTheme.headlineSmall),
                if (!loggedIn)
                  Text(
