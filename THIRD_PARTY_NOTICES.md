...
以下为 Flule34 1.0.0 的直接 Dart/Flutter 依赖。完整许可证文本可在 App 的“关于 Flule34 → 开源许可”中查看，也可在对应包源码的 `LICENSE` 文件中核对。传递依赖同样会由 Flutter 许可证注册表展示。
...
| background_downloader | 9.5.6 | BSD-3-Clause |
| dio | 5.10.0 | MIT |
| cookie_jar | 4.0.9 | MIT |
| dio_cookie_manager | 3.4.0 | MIT |
| drift | 2.34.0 | MIT |
| drift_flutter | 0.3.1 | MIT |
| sqlite3 | 3.5.0 | MIT |
| html | 0.15.6 | BSD-3-Clause |
